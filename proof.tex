...
$$\eqalign{M_2(n)&=\sum^{a-c}_{b=0}2^a+\sum^{a}_{b=a-c+1}2^{a+1}\ -2^{a+1}+1\cr
...
$$M_3(f_3(a))=\sum^a_{b=0}2^bM_2(f_2(a-b))=h_3(a)2^a-1$$
...
alternating series that is dependant on $f$ because of nested sums
